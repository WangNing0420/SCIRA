...
#' @param capth A numeric, the significant correlations threshold,in the range between 0 and 1, used to pick the most significant correlations. The default value is 0.01, means pick the top 1 percent of associations.
